  ...
  return (
    <Modal open onClose={onClose} maxWidth="860px">
      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#a78bfa] to-[#7c3aed] flex items-center justify-center text-white font-bold text-xl shrink-0 shadow-[0_4px_12px_rgba(124,58,237,0.25)]">
      ...
      <div className="grid grid-cols-[1fr_1fr] gap-6">
        ...
        <div>
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="mt-4 px-5 py-2.5 rounded-xl bg-[var(--color-accent)] text-white text-sm font-semibold hover:bg-[#6d28d9] transition-all cursor-pointer disabled:opacity-50"
          >
