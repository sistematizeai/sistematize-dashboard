...
export function AppointmentFormModal({
  ...
  return (
      ...
      footer={
        <>
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#4A6CF7] to-[#6C5CE7] text-white text-sm font-semibold hover:brightness-110 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
    ...
    >
      ...
      <div>
        <label className={modalLabelClass}>Cliente</label>
      ...
      {/* Services pill grid */}
      <div>
        <label className={modalLabelClass}>Servicos</label>
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-2 rounded-xl text-sm font-medium border transition-all cursor-pointer ${
                    isSelected
                      ? 'bg-gradient-to-r from-[#4A6CF7] to-[#6C5CE7] text-white border-[var(--color-accent)]'
      ...
      {/* Collaborator */}
      <div>
        <label className={modalLabelClass}>Colaborador</label>
        <select
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className={modalLabelClass}>Data</label>
          <input
            type="date"
            value={date}
        ...
        <div>
          <label className={modalLabelClass}>Horario</label>
          <input
            type="time"
            value={startTime}
